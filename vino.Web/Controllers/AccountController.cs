...
using vino.Sessions;
using vino.Web.Controllers.Results;
using vino.Web.Models;
using vino.Web.Models.Account;
using Microsoft.AspNet.Identity;
using Microsoft.AspNet.Identity.Owin;
using Microsoft.Owin.Security;

namespace vino.Web.Controllers
{
    public class AccountController : vinoControllerBase
    {
